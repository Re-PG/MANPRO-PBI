...
<head>
    ...
    @if(Auth::user())
      ...
      {{-- <link rel="stylesheet" href="/css/summernote.css" media="screen" title="no title" charset="utf-8">
      <script type="text/javascript" src="/js/summernote.js"></script>
      {{-- <script type="text/javascript" src="/js/summernote.min.js"></script> --}}
      {{-- <script type="text/javascript" src="/js/summernote-ext-hello.js"></script>
      <script type="text/javascript" src="/js/summernote-ext-specialchars.js"></script> --}} --}}
    @endif
</head>
...
<body id="page-top">
    ...
    <section class="bg-primary" id="visi-misi">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center" id='visiMisiContent'>
